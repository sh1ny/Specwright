...
- [ ] T001: Make OMP status refresh non-mutating and race-safe
...
- [ ] T002: Preserve user-owned OMP files during adapter regeneration
...
- [ ] T003: Arm lifecycle routing only after successful prompts
