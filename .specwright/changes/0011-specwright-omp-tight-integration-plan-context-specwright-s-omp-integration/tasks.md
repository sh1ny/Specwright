...
- [x] T005: Register structured Specwright OMP tools
...
- [x] T006: Enforce lifecycle routing through `tool_call`
  - Files: `src/runtime/omp/extension.ts`, `src/runtime/omp/types.ts`, `test/omp-extension.test.ts`
...
- [x] T007: Cache OMP status validation by artifact mtime
...
- [x] T008: Surface blocked, drift, and checkpoint-needed status
  - Files: `src/runtime/omp/status.ts`, `test/omp-extension.test.ts`
