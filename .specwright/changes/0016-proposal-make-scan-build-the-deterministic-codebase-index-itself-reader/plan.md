...
Classify package scripts, obvious CLI/bin entrypoints, conventional source modules, test files, verification commands, and mechanically extractable command names. Cap defaults are maxFilesScanned = 50000, maxGitLsFilesBytes = 64 * 1024 * 1024, maxIndexedFiles = 5000, maxFingerprintBytesPerFile = 1048576, and maxRisksPerArea = 64; scanned-file, Git-output, and indexed-file cap hits record area: "scan coverage", oversized indexed files record area: "large file skipped", symlink skips record area: "symlink skipped", unsafe-path skips record area: "unsafe path skipped", and per-area risk omissions set the result truncated flag.
